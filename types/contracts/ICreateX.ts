...
export declare namespace ICreateX {
...
export interface ICreateXInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ICreateX extends BaseContract {
  connect(runner?: ContractRunner | null): ICreateX;
  waitForDeployment(): Promise<this>;

  interface: ICreateXInterface;
  ...
  "deployCreate2AndInit(bytes,bytes,(uint256,uint256))": TypedContractMethod<
    [initCode: BytesLike, data: BytesLike, values: ICreateX.ValuesStruct],
    [string],
    "payable"
  >;
